...
/**
 * Class Septheuredix_About
 */
class Septheuredix_About extends WP_Widget {

	/**
	 * Septheuredix_About constructor.
	 */
	public function __construct() {
		$widget_ops  = array(
			'classname' => 'septheuredix_about',
			'description' => __( 'About me widget.', 'septheuredix' ),
		);
		$control_ops = array(
			'width' => 400,
			'height' => 350,
		);
		parent::__construct( 'septheuredix_about', __( 'Septheuredix: About me', 'septheuredix' ), $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'image_url' ); ?>"><?php _e( 'Enter the URL for your photo', 'septheuredix' ); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id( 'text' ); ?>"><?php _e( 'Add your text:', 'septheuredix' ); ?></label>
		...
		<p><input id="<?php echo $this->get_field_id( 'filter' ); ?>" name="<?php echo $this->get_field_name( 'filter' ); ?>" type="checkbox" <?php checked( isset( $instance['filter'] ) ? $instance['filter'] : 0 ); ?> />&nbsp;<label
					for="<?php echo $this->get_field_id( 'filter' ); ?>"><?php _e( 'Automatically add paragraphs', 'septheuredix' ); ?></label></p>
		<?php
	}
}
