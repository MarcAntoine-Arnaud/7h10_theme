...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-thumb">
		<?php the_post_thumbnail( 'septheuredix-entry-thumb' ); ?>
	...
	<div class="post-inner">
		...
		<div class="entry-content">
				...
				the_content(
					sprintf(
						/* translators: Title of the post */
						 __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'septheuredix' ),
			...
			<?php
				wp_link_pages(
					array(
						'before' => '<div class="page-links">' . __( 'Pages:', 'septheuredix' ),
						'after'  => '</div>',
					)
				);
			?>
