 ...
 * Dynamic styles
 */
function septheuredix_custom_styles() {
	...
	// Sub Menu colors
	$color_submenu_1 = get_theme_mod( 'color_submenu_1', '#FF0000' );
	$custom .= '.main-navigation .container.submenu .menu-item:nth-child(1) a { color:' . esc_attr( $color_submenu_1 ) . ' !important;}' . "\n";
	$backgroundcolor_submenu_1 = get_theme_mod( 'backgroundcolor_submenu_1', '#FF0000' );
	$custom .= '.main-navigation .container.submenu .menu-item:nth-child(1) { background-color:' . esc_attr( $backgroundcolor_submenu_1 ) . ' !important;}' . "\n";

	$color_submenu_2 = get_theme_mod( 'color_submenu_2', '#FF0000' );
	$custom .= '.main-navigation .container.submenu .menu-item:nth-child(2) a { color:' . esc_attr( $color_submenu_2 ) . ' !important;}' . "\n";
	$backgroundcolor_submenu_2 = get_theme_mod( 'backgroundcolor_submenu_2', '#FF0000' );
	$custom .= '.main-navigation .container.submenu .menu-item:nth-child(2) { background-color:' . esc_attr( $backgroundcolor_submenu_2 ) . ' !important;}' . "\n";

	$color_submenu_3 = get_theme_mod( 'color_submenu_3', '#FF0000' );
	$custom .= '.main-navigation .container.submenu .menu-item:nth-child(3) a { color:' . esc_attr( $color_submenu_3 ) . ' !important;}' . "\n";
	$backgroundcolor_submenu_3 = get_theme_mod( 'backgroundcolor_submenu_3', '#FF0000' );
	$custom .= '.main-navigation .container.submenu .menu-item:nth-child(3) { background-color:' . esc_attr( $backgroundcolor_submenu_3 ) . ' !important;}' . "\n";

	$color_submenu_4 = get_theme_mod( 'color_submenu_4', '#FF0000' );
	$custom .= '.main-navigation .container.submenu .menu-item:nth-child(4) a { color:' . esc_attr( $color_submenu_4 ) . ' !important;}' . "\n";
	$backgroundcolor_submenu_4 = get_theme_mod( 'backgroundcolor_submenu_4', '#FF0000' );
	$custom .= '.main-navigation .container.submenu .menu-item:nth-child(4) { background-color:' . esc_attr( $backgroundcolor_submenu_4 ) . ' !important;}' . "\n";

	$backgroundcolor_submenu = get_theme_mod( 'branding_bg', '#FF0000' );
	$custom .= '.main-navigation .container.submenu { background-color:' . esc_attr( $backgroundcolor_submenu ) . ' !important;}' . "\n";
	...
	wp_add_inline_style( 'septheuredix-style', $custom );
}
add_action( 'wp_enqueue_scripts', 'septheuredix_custom_styles' );
