<?php
/**
 *  Septheuredix Upsell Theme Info Class
 *
 * @package Septheuredix
 */

if ( ! class_exists( 'Septheuredix_Control_Upsell_Theme_Info' ) ) :

	/**
	 * Septheuredix_Control_Upsell_Theme_Info class.
	 */
	class Septheuredix_Control_Upsell_Theme_Info extends WP_Customize_Control {
		 ...
		 */
		public $type = 'marcantoinearnaud-control-upsell';
		...
		/**
		 * Septheuredix_Control_Upsell_Theme_Info constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Septheuredix_Control_Upsell_Theme_Info' );
		...
		public function enqueue() {
			wp_enqueue_style( 'marcantoinearnaud-upsell-style', get_template_directory_uri() . '/inc/class/class-customizer-theme-info-control/css/style.css', '1.0.0' );
		}
	...
	?>
			<div class="marcantoinearnaud-upsell">
				<# if ( data.options ) { #>
